 ...
 */
public class GoldChangeFragment extends Fragment {
    private View view;
    private Button gold_exchange;
    private PersistentCookieStore persistentCookieStore;
    private MyProgressDialog animDialog;
    private Call call;
    private TextView gold_num,gold_can;
                ...
                case GET_ALL:
                    ...
                    try {
                        ...
                        if (object.getString("result").equals("success")){
                            ...
                            gold_num.setText(data.getString("gold"));
                            gold_can.setText(data.getString("getCash"));

                            if (data.getString("flag").equals("0")){
                                gold_exchange.setOnClickListener(new View.OnClickListener() {
                                    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = LayoutInflater.from(getActivity()).inflate(R.layout.gold_change, container, false);
        gold_num = (TextView) view.findViewById(R.id.gold_num);
        gold_can = (TextView) view.findViewById(R.id.gold_can);
        gold_exchange = (Button) view.findViewById(R.id.gold_exchange);
        getdata();
        return view;
    }

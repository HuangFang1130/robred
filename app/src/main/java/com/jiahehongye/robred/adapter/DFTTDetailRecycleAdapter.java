...
//                return new HomeHeadViewHolder(headView, mHeadClickListener);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HomeSingleContentViewHolder) {
            onBindContentViewHolder((HomeSingleContentViewHolder) holder, fatherArraylist.get(position - (getItemCount()-fatherArraylist.size())));
        }
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM_TYPE_BIG_ADV:
                onbindConteBigAdvHolder((FreshBigADVViewHolder) holder);
                break;
            ...
            case ITEM_TYPE_CONTENT_THREE:
                onbindConteBigAdvthreeHolder((FreshNewsADVViewHolderfdasf) holder, fatherArraylist.get(position - (getItemCount()-fatherArraylist.size())));
    ...
    private void onbindConteBigAdvHolder(FreshBigADVViewHolder holder) {
        if (data1AdvList != null) {
            if (data1AdvList.size() > 0) {
                DFTTNewsResult.DataBean dataBean = data1AdvList.get(0);
...
//                    animDialog.dismiss();
    ...
    private class FreshBigADVViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public FreshBigADVViewHolder(View avdTwo3, MyItemClickListener mItemClickListener) {
            ...
            des = (TextView) itemView.findViewById(R.id.des);
            zhiding = (TextView) itemView.findViewById(R.id.zhiding);
//            mTvDAD = (TextView) itemView.findViewById(R.id.adv_dddd);

            ...
            switch (msg.what) {
                case MESSAGE_SYSTEM_SUCCESS:
                    ...
                    if(findMessage!=null){
                        ...
                        systemListRecycleAdapter.hintFootView();
...
//        mTintManager.setStatusBarTintResource(R.color.home_white_color);
    ...
    private void initView() {
        ...
        //滑动的监听
        mSystemRecycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (lastVisiblePosition >= linearLayoutManager.getItemCount() - 1) {
                        if(systemListRecycleAdapter!=null)systemListRecycleAdapter.showFootView();

...
public class CallActivity extends BaseActivity implements EaseChatFragment.EaseChatFragmentHelper{
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
//        .putExtra("Name",name2)
//                .putExtra("Avatar",avatar2)
//                .putExtra("Avatar2",avatar)
//                .putExtra("Name2",name)
        audioManager = (AudioManager) this.getSystemService(Context.AUDIO_SERVICE);
        Intent intent = getIntent();

        name = intent.getStringExtra("Name");//自己的
        avatar = intent.getStringExtra("Avatar");

        avatar2 = intent.getStringExtra("Avatar2");

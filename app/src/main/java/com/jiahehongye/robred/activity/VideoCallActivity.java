...
//    private Button recordBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppHelper.getInstance().isVideoCalling = true;
        callType = 1;
...
//                                    Toast.makeText(VideoCallActivity.this, "对方不在线，暂时无法通话！", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
    ...
    protected void onDestroy() {
        AppHelper.getInstance().isVideoCalling = false;
        stopMonitor();
        if(isRecording){
            callHelper.stopVideoRecord();
            isRecording = false;

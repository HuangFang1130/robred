...
//            mViewDetailPhoto.setVisibility(View.GONE);
            ...
            Glide.with(UIUtils.getContext()).load(photosBean.getPhoto())
                    ...
                    .transform(new CenterCrop(UIUtils.getContext()),new GlideRoundTransform(UIUtils.getContext())).into(one);
            ...
            Glide.with(UIUtils.getContext()).load(photosBean.getPhoto())
                    ...
                    .error(R.mipmap.headsq_pic)
                    .placeholder(R.mipmap.headsq_pic).transform(new CenterCrop(UIUtils.getContext()),new GlideRoundTransform(UIUtils.getContext())).into(one);
            Glide.with(UIUtils.getContext()).load(photosBean2.getPhoto())

                    .error(R.mipmap.headsq_pic)
                    .placeholder(R.mipmap.headsq_pic).transform(new CenterCrop(UIUtils.getContext()),new GlideRoundTransform(UIUtils.getContext())).into(two);
            three.setVisibility(View.GONE);
            four.setVisibility(View.GONE);
            ...
            Glide.with(UIUtils.getContext()).load(photosBean3.getPhoto())
                    .error(R.mipmap.headsq_pic)
                    .placeholder(R.mipmap.headsq_pic).transform(new CenterCrop(UIUtils.getContext()),new GlideRoundTransform(UIUtils.getContext())).into(three);
            ...
            Glide.with(UIUtils.getContext()).load(photosBean4.getPhoto())
                    .error(R.mipmap.headsq_pic)
                    .placeholder(R.mipmap.headsq_pic).transform(new CenterCrop(UIUtils.getContext()),new GlideRoundTransform(UIUtils.getContext())).into(four);
        }else {
            AddressDetailResult.PhotosBean photosBean = data.getResList().get(0);
            AddressDetailResult.PhotosBean photosBean2 = data.getResList().get(1);
            AddressDetailResult.PhotosBean photosBean3 = data.getResList().get(2);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initView();
        String loginmobile = (String) SPUtils.get(UIUtils.getContext(), Constant.LOGIN_MOBILE, "");
...
//        four_bg.setLayoutParams(ff);
        ...
        mIvAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UIUtils.getContext(),LookHeadImageActivity.class).putExtra("url",userPhoto));
            }
        });

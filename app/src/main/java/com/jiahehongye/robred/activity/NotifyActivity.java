...
public class NotifyActivity extends BaseActivity implements View.OnClickListener {
            ...
            switch (msg.what) {
                case MESSAGE_NOTIFY_SUCCESS:
                    ...
                    if(findMessage!=null){
                        ...
                        notifyListRecycleAdapter.hintFootView();
    ...
    private void initView() {
        ...
        //滑动的监听
        mNotifyRecycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (lastVisiblePosition >= linearLayoutManager.getItemCount() - 1) {
                        if(notifyListRecycleAdapter!=null)notifyListRecycleAdapter.showFootView();

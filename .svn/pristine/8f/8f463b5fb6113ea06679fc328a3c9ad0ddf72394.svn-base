...
public class AddressOneyuanActivity extends BaseActivity {
	...
	private RelativeLayout shouhuodizhi_back;
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_address_oneyuan);
//		base_title.setText("填写收货地址");
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				}else if (province.getText().length()<2||city.getText().length()<2||town.getText().length()<1||detail.getText().length()<2) {
	...
	private void initView() {
		...
		shouhuodizhi_back = (RelativeLayout) findViewById(id.shouhuodizhi_back);

		shouhuodizhi_back.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				finish();
			}

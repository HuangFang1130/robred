 ...
 */
public class SnatchFinishFragment extends Fragment{
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = LayoutInflater.from(getActivity()).inflate(R.layout.snatch_finish, container, false);
        list_finish = (ListView) view.findViewById(R.id.list_finish);
        ...
        list_finish.setAdapter(adapter);

        list_finish.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override

 ...
 */
public class SnatchingFragment extends Fragment {
    private View view;
    ...
    private ListView list_duobaoing;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = LayoutInflater.from(getActivity()).inflate(R.layout.snatch_ing, container, false);
        list_duobaoing = (ListView) view.findViewById(R.id.list_duobaoing);
        ...
        list_duobaoing.setAdapter(adapter);

        list_duobaoing.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override

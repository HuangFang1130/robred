...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        inflate = inflater.inflate(R.layout.ease_fragment_chat, container, false);
...
//        }
    ...
    public onClickGiftLinstener lisener;
    public interface onClickGiftLinstener{
        void onClickGift();
    }

    public void setOnClickGiftListener(onClickGiftLinstener lisener){
